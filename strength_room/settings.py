"""
Django settings for strength_room project.
...
ROOT_URLCONF = 'strength_room.urls'
...
WSGI_APPLICATION = 'strength_room.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'ms4-strength-room'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'strengthroom@example.com'
else:
